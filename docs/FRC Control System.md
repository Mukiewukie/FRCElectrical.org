...
- CAN   
  - CAN can be wired in two different ways:  
    ...
    - Star topology (DO NOT DO): This is the method used to branch the CAN bus by each individual component. This is used by some teams because in a normal CAN bus, if one component loses a connection, they all do. With a Star topology, each component has its own individual “CAN bus”. 
...
![Brushed Motor](thing syntax){ align=left }
...
- [Talon FXS](https://store.ctr-electronics.com/products/talon-fxs?srsltid=AfmBOoqrDtivYz01ZhMZN83ueCLV9vtFR7v5zd-r1RJh8Oi5vd6bPA7f) (Best motor controller for   
...
!!! warning
    ...
    DO NOT use the Optifuse breaker. It is more prone to popping than any other brand and as such should be avoided.
...
- [https://docs.wpilib.org/en/latest/docs/software/systemcore-info/systemcore-introduction.html](https://docs.wpilib.org/en/latest/docs/software/systemcore-info/systemcore-introduction.html)   
- [https://community.firstinspires.org/systemcore-alpha-testing-first-wave](https://community.firstinspires.org/systemcore-alpha-testing-first-wave) 

### Small output power distribution
...
- [Rev MPM](https://www.revrobotics.com/rev-11-1956/)  
- [VRM](https://store.ctr-electronics.com/products/voltage-regulator-module?srsltid=AfmBOoqSvxCWOi-S_hmZN64-mYdpfNRXR3D-_3f4hC0ErgdFZawhhgSz)

### Cameras

- These are for vision processing. They’re important in both autonomous and tele-operated periods of your robot.  
- Arducams (available on amazon and work with arduinos)  
- [ThriftyCAM](https://www.thethriftybot.com/products/thriftycam) (Best choice for Price)  
- [Limelight](https://limelightvision.io/products/limelight-4) (Best choice for Quality)
...
- Mag Switch  
- CANandColor  
- Mukesh can u do these im not really familiar

### Absolute Encoders

- These allow for the rotational accuracy of shafts. This is important for swerve drive accuracy rotationally as well as other precise mechanisms.  
- [CANcoder](https://store.ctr-electronics.com/products/cancoder?srsltid=AfmBOopMkyo06dBAH539RzxGtOrRWVFucKvbhMIicJZMIfOLGcY7CCxZ) (Best encoder for quality)  
- [TTB Magnetic Encoder](https://www.thethriftybot.com/products/thrifty-absolute-magnetic-encoder) (Best encoder for price)
...
- VividHosting’s Robot Radio 2.0 (no link yet) is what gets the signal from the driver station to relay information to the robot to make it do all the fun things robots do. Placement of this is especially important and should be done with care.   
  ...
  - The radio should be easily removable, as it is programmed each competition.  
